...
export function useObservableResult<D>(observable: Observable<D>) {
...
export function withObservable<I extends {}, D extends {}>(factory: (props: I) => Observable<D>, overrides: LazyOverrides<I> = {}) {
    return withLazy((props: I) => ({ result: useObservableResult(factory(props)), pass: {} }), overrides)
}
...
export function withObservableAs<I extends {}, D, K extends string>(key: K, factory: (props: I) => Observable<D>, overrides: LazyOverrides<I> = {}) {
    return withLazy((props: I) => ({ result: addKeyToPromiseResult(key, useObservableResult(factory(props))), pass: {} }), overrides)
}
